...
class PointSourcePointLens(pm.Model):
    ...
    def __init__(self, data, use_joint_prior=True, name='', model=None):
        ...
        self.ln_t0 = pm.DensityDist('ln_t0', self.prior_ln_t0,testval=self.t[t0_guess_idx])
        ...
        Y_obs = pm.Normal('Y_obs', mu=self.mean_function(), sd=(T.exp(self.ln_K) + 1)*self.sigF, 
